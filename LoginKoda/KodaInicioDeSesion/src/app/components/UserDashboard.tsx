...
import {
  ...
  Plus, ExternalLink, Building2, Calculator, RefreshCw, Receipt, Upload, Banknote, Lock, Eye
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 pb-32">
      ...
      {activeTab === 'inicio' && (
        <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
          ...
          {/* Mis Gestiones */}
          <div className="space-y-4">
            <h2 className="text-white text-xl font-semibold px-2">Mis Gestiones</h2>
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-5 border border-white/20 shadow-lg">
              <div className="space-y-4">
                <div className="flex justify-between items-center border-b border-white/10 pb-4">
                  <div>
                    <h3 className="text-white font-semibold">Filtración en el techo</h3>
                    <p className="text-white/60 text-xs mt-1">Reportado el 28 de enero</p>
                  </div>
                  <span className="bg-yellow-500/20 text-yellow-300 border border-yellow-500/30 px-3 py-1 rounded-full text-xs font-semibold">
                    En Proceso
                  </span>
                </div>
                ...
                <div className="flex justify-between items-center border-b border-white/10 pb-4">
                  <div>
                    <h3 className="text-white font-semibold">Luz del pasillo no funciona</h3>
                ...
                <div className="flex justify-between items-center pt-2">
                  <div>
                    <h3 className="text-white font-semibold">Puerta principal dañada</h3>
                    <p className="text-white/60 text-xs mt-1">Reportado el 15 de enero</p>
                  </div>
                  <span className="bg-gray-500/20 text-gray-300 border border-gray-500/30 px-3 py-1 rounded-full text-xs font-semibold">
                    Pendiente
                  </span>
                </div>
              </div>
